...
####
#### This script creates the nessesary virtual machines using VirtualBox.
#### You can set the preferred variables below to customize the setup.
####
...
$vmMemoryMb = 2048 # Amount of RAM in megabytes
